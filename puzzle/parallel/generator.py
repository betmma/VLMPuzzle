...
class ParallelGenerator(PointTargetPuzzleGenerator):
    ...
    DEFAULT_PROMPT="Draw a line through the small circle and parallel to the existing line. Speak out which option is on the new line using phonetic alphabet"

...
class PerpendicularGenerator(PointTargetPuzzleGenerator):
    ...
    DEFAULT_PROMPT="Draw a black ine perpendicular to the existing line and passing the small circle. Speak out which option is on the line using phonetic alphabet and mark that red. In portrait, no zoom, no pan."
